								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1>Gracias </h1>
											<hr/>
											<p>Hello <?php echo "<b>".$_SESSION["name"]."</b>"; ?>,Su proceso de pago es 
											completado correctamente y su ID de transacción es <b><?php echo $trx_id; ?></b><br/>
											puede continuar con sus compras <br/></p>
