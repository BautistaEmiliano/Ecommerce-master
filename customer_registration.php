		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading">Formulario de Registro de Usuarios</div>
					...
					<form id="signup_form" onsubmit="return false">
						...
						<div class="row">
							<div class="col-md-12">
								<label for="repassword">Confirmar Contrseña</label>
						...
						<div class="row">
							<div class="col-md-12">
								<label for="address1">Direccion Linea 1</label>
								<input type="text" id="address1" name="address1"class="form-control">
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<label for="address2">Direccion Linea 2</label>
