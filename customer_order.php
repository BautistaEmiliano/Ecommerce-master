			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<h1>Detalles de Orden del Cliente</h1><a href="pdf_pedidos.php"> Reporte</a>
						<hr/>
						<?php
							include_once("db.php");
										...
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													...
													<tr><td>Precio del Producto</td><td><b><?php echo  CURRENCY." ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Cantidad</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
													<tr><td>Id de la Transaccion</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
